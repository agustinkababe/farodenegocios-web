...
export type DatosMailInforme = {
  ...
  informeUrl: string;     // URL de tracking (/r/[id]) — registra el clic antes de redirigir
  unsubscribeUrl: string; // URL real de baja (/baja/[token])
};
...
function buildHtmlInforme({
  ...
  return wrapBase(
    ...
    <p style="margin:0 0 28px;font-size:14px;color:#475569;line-height:1.65;">
    ...
    <p style="margin:28px 0 0;font-size:13px;color:#64748b;line-height:1.65;
      ...
      <a href="https://fiable.com.ar" style="color:#4f46e5;text-decoration:none;font-weight:600;">fiable</a>
...
function buildHtmlSeguimiento1({
  ...
  // Personalización secundaria: solo si hay tarea y se integra naturalmente
  const bloquePersonal = tarea
    ? `<p style="margin:0 0 16px;font-size:14px;color:#475569;line-height:1.65;">
        En tu caso — lo de
        "<span style="color:#334155;font-style:italic;">${tarea}</span>" —
  ...
  return wrapBase(
    `
    <p style="margin:0 0 20px;font-size:15px;font-weight:700;color:#0f172a;line-height:1.35;">
    ...
    <p style="margin:24px 0 0;font-size:13px;color:#94a3b8;line-height:1.65;">
      Tu informe también sigue disponible:
      <a href="${informeUrl}" style="color:#94a3b8;text-decoration:underline;">verlo acá</a>.
    </p>
    `,
    unsubscribeUrl
  );
...
// ─── Seguimiento 2 (~7 días) — FOMO + cierre suave ────────────────────────────
...
function buildHtmlSeguimiento2({
  ...
  return wrapBase(
    ...
    <p style="margin:24px 0 0;font-size:13px;color:#94a3b8;line-height:1.65;">
      Tu informe:
      <a href="${informeUrl}" style="color:#94a3b8;text-decoration:underline;">seguir leyendo</a>.
    </p>
    `,
    unsubscribeUrl
  );
